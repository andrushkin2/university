...
var devFolderPath = "./public/dev", tsConfig = JSON.parse(fs.readFileSync("./tsconfig.json", "utf-8")), outPut = "./public/scripts", outPutJs = outPut + "/js/", createPathToDev = function (file) {
